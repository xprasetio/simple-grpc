...
type User struct {
	...
	Educations    []string `protobuf:"bytes,8,rep,name=educations,proto3" json:"educations,omitempty"` // List of educational qualifications [e.g., "BSc", "MSc", "PhD"]
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x06height\x18\x04 \x01(\x02R\x06height\x12\x18\n" +
	"\abalance\x18\x05 \x01(\x01R\abalance\x12\x1b\n" +
	"\tis_active\x18\x06 \x01(\bR\bisActive\x12'\n" +
	"\aaddress\x18\a \x01(\v2\r.user.AddressR\aaddress\x12\x1e\n" +
	"\n" +
	"educations\x18\b \x03(\tR\n" +
